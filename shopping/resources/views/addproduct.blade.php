...
<body>
    <div class="content">
        ...
        <form method="post" enctype="multipart/form-data" action="{{url('/addfinish')}}">
            {{csrf_field()}}
                ...
                <div class="form-group">
                    <span>價格:</span>
                    <input type="number" class="form-control" id="productprice" name="productprice" oninput="if(value<1)value=1"/>
                </div>
                <div class="form-group">
                    <span>數量:</span>
                    <input type="number" class="form-control" id="productquantity"  name="productquantity"oninput="if(value<0)value=0"
                        style="width:80px;" max="999"/>
                </div>
                <div class ="form-group">
